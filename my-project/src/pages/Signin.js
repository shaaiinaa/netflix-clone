    ...
    <div className='absolute w-full px-4 py-24 z-50'>
       <div className='w-[400px] h-[500px] mx-auto absolute bottom-[250px] right-[35%] bg-black/75 text-white'>
        <div className='max-w-[320px] mx-auto py-16'>
          ...
          <input type="email" placeholder='Email' className='my-6 py-2 bg-gray-700 rounded'/>
          <input type="password" placeholder='Password' autoComplete='current-password' className='py-2 bg-gray-700 rounded' />
